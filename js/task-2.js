...
function displayCalories() {
    ...
    outputDiv.innerHTML += `Середня кількість калорій: ${average1.toFixed(2)}<br>`; // Виводимо середнє значення
    ...
    outputDiv.innerHTML += `Середня кількість калорій: ${average2.toFixed(2)}<br>`; // Виводимо середнє значення
